...
def resnet18_encoder(first_conv, maxpool1, pretrained_weights=None):
    return _resnet_encoder(arch="resnet18", block=EncoderBlock, layers=[2, 2, 2, 2], pretrained_weights=pretrained_weights, first_conv=first_conv, maxpool1=maxpool1)

def resnet50_encoder(first_conv, maxpool1, pretrained_weights=None):
    return _resnet_encoder(arch="resnet50", block=EncoderBottleneck, layers=[3, 4, 6, 3],  pretrained_weights=pretrained_weights, first_conv=first_conv, maxpool1=maxpool1)
...
def resnet18_decoder(latent_dim, input_height, first_conv, maxpool1, pretrained_weights=None):
    return _resnet_decoder(arch="resnet18", block=DecoderBlock, layers=[2, 2, 2, 2], latent_dim=latent_dim,
                           input_height=input_height, first_conv=first_conv, maxpool1=maxpool1,  pretrained_weights=pretrained_weights)
