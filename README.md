...
|-------------------------------|--------------------------------------------------------------------------|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| 3CPO | [Poisson Subspace Clustering: Focusing on the Essentials in Count Data](https://arxiv.org/abs/2608.23287) | DAMI 2026 | [Link](https://github.com/collinleiber/3CPO) (Python) | [Link](https://clustpy.readthedocs.io/en/latest/clustpy.centroid.html#clustpy.centroid.threecpo.ThreeCPO) |
