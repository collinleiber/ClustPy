...
from .real_world_data import load_har, load_letterrecognition, \
    ...
    load_banknotes, load_htru2, load_motestrain, load_mice_protein, load_ecoli, \
    load_spambase, \
    load_seeds, load_shuttle, load_olive_oil, load_symbols, load_diatom_size_reduction, load_proximal_phalanx_outline, \
    load_forest_types, load_breast_tissue, load_soybean_large, load_soybean_small, load_skin, load_user_knowledge, \
    load_plane
from .real_nr_data import load_aloi, load_fruit, load_nrletters, load_stickfigures, load_webkb, load_cmu_faces
from .real_torchvision_data import load_usps, load_mnist, load_fmnist, load_kmnist
