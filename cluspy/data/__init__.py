...
from .real_world_data import load_har, load_letterrecognition, \
    ...
    load_plane, load_dermatology, load_multiple_features, load_statlog_australian_credit_approval, \
    load_breast_cancer_wisconsin_original, load_semeion, load_sony_aibo_robot_surface, load_two_patterns, load_lsst
