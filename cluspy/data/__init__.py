...
from .real_world_data import load_har, load_usps, load_mnist, load_fmnist, load_kmnist, load_letterrecognition, \
    ...
    load_banknotes, load_htru2, load_motestrain, load_cmu_faces, load_mice_protein, load_webkb, load_ecoli, \
    load_spambase, \
    ...
    load_plane
from .read_nr_data import load_aloi, load_fruit, load_nrletters, load_stickfigures
