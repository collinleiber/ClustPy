import numpy as np
from cluspy.partition import DipExt, DipInit
from cluspy.partition.dipext import _dip_scaling, _n_starting_vectors_default, _angle, _get_random_modal_triangle
