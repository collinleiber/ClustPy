...
from cluspy.utils import plot_with_transformation, plot_1d_data, plot_2d_data, plot_3d_data, plot_histogram, plot_image, \
    plot_scatter_matrix
import numpy as np
from sklearn.decomposition import PCA, FastICA
from cluspy.data import load_nrletters, load_optdigits
