...
def _kmeans_plus_plus(X, n_clusters, x_squared_norms=None, random_state=None, n_local_trials=None):
    result = kpp(X, n_clusters, x_squared_norms=x_squared_norms, random_state=random_state,
